...
CREATE TABLE `tabela_orcamento` (
  ...
  `vlr_venda_orcamento` decimal(10,2) DEFAULT NULL,
  `vlr_lucro_orcamento` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `tabela_orcamento_produto` (
  ...
  `nome_produto` varchar(100) DEFAULT '',
  ...
  CONSTRAINT `fk_tb_orcamento_has_tb_produtos_tb_orcamento1` FOREIGN KEY (`id_orcamento`) REFERENCES `tabela_orcamento` (`id_orcamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_config_sistema` VALUES (1,'teste','Rua Teste',123,'Carijós','Indaial','(47)3333-3333','teste@teste');
...
CREATE TABLE `tb_produtos` (
  ...
  `preco_custo_prod` decimal(6,2) DEFAULT NULL,
  `preco_venda_prod` decimal(6,2) NOT NULL,
...
-- Dump completed on 2018-12-01 14:06:33
